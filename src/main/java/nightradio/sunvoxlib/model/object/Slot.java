...
import nightradio.sunvoxlib.model.number.*;
import nightradio.sunvoxlib.model.object.module.Module;

import java.io.File;

import static nightradio.sunvoxlib.model.SunVoxException.intIfOk;
import static nightradio.sunvoxlib.model.SunVoxException.voidIfOk;

public class Slot implements AutoCloseable {
    private final SunVoxLibraryWrapper engine;
    /**
     * slot number
     */
    ...
    public Slot(SunVoxLibraryWrapper engine, int id) {
        this.engine = engine;
        this.id = id;
        openSlot();
    }

    public SunVoxLibraryWrapper getEngine() {
        return engine;
    }
