...
public class SunVoxLibraryWrapper implements AutoCloseable {
    protected static SunVoxLibraryWrapper INSTANCE = new SunVoxLibraryWrapper();

    public static SunVoxLibraryWrapper getInstance() {
        return INSTANCE;
    }
